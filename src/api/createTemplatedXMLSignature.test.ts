...
import { createTemplatedXMLSignature } from "./createTemplatedXMLSignature";
...
describe('createTemplatedXMLSignature', () => {
  test('uses specified certificate', async () => {
    await createTemplatedXMLSignature(parsedCertificateMock.thumbprint, 'message', true);
