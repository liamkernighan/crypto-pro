...
/***/ "./api/createTemplatedXMLSignature.ts":
/*!********************************************!*\
  !*** ./api/createTemplatedXMLSignature.ts ***!
  \********************************************/
/*! no static exports found */
 ...
 * @returns подпись
 */
exports.createTemplatedXMLSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, unencryptedMessage, checkCertificate = true) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
...
__export(__webpack_require__(/*! ./createTemplatedXMLSignature */ "./api/createTemplatedXMLSignature.ts"));
